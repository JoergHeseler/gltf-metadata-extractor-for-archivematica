...
You can use the validator at the command line prompt by typing `python gltf-metadata-extractor.py --file-full-name=<gltf file path to characterize>`. You might also add `--validator-path=<path to the official gltf_validator>`.
